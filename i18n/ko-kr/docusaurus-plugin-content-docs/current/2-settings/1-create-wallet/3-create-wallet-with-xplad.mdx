...
<Tabs groupId="operating-systems">
  ...
  <TabItem value="win" label="Windows">
    1. <a target="_blank" href="https://go.dev/doc/install">
    Golang 최신 버전
    </a>
    을 설치하시고, <code>GOPATH</code>와 <code>GOBIN</code> 환경 변수를 설정해줍니다.
    <br/>
    <br/>
    2. <a target="_blank" href="https://github.com/xpladev/xpla">
    Github
    </a>
