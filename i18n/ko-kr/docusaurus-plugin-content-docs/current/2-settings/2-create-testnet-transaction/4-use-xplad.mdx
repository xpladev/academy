...
xplad로 cli에서 트랜잭션을 생성하고, query를 보낼 수도 있습니다. xplad를 설치하지 않으셨다면, [다음 단계](/docs/tutorial/make-cw20/make-cw20-with-vault)로 넘어가셔도 좋습니다. 
...
```bash
xplad tx bank send <from-key-or-address> <to-address> <coins> --chain-id=<chain-id> --fees=<fee> --node tcp://34.64.250.213:26657 // 추후 xplad query tx E832D9C480EC2E6F3856ED4424892F9AC5A4704C3B9A2EE085C20A8D3832E6BB --node https://cube-rpc.xpla.dev:443 으로 수정할 것.
``` 
