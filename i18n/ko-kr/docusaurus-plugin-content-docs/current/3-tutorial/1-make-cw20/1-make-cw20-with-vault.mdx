...
[Vault 웹사이트](http://vault.xpla.io)에서 Vault Chrome Extension를 사용한다면, **Chrome 팝업 차단 해제**를 설정해야 합니다. Vault를 이용하기 전에 **[Chrome 팝업 차단 해제](https://support.google.com/chrome/answer/95472)**를 진행해주세요.
