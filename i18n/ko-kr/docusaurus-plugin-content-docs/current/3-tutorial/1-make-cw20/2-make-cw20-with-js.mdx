...
이렇게 CW20 토큰 전송까지 알아보았습니다. 이제 여러분의 게임에 CW20 토큰을 이용하여 XPLA 블록체인과 연결해보세요! [다음 단계](/startlearning/tutorial/make-cw20/query-cw20)에서는 직접 만든 CW20 토큰의 데이터를 블록체인에서 가져와보겠습니다.