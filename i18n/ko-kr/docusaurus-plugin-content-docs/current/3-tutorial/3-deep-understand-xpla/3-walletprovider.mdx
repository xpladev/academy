...
Wallet Provider로 유저의 Vault 지갑 정보를 받아, 테스트넷 XPLA 전송까지 진행할 수 있었습니다. Preview Code를 이해하셨다면 [다음 단계](/docs/tutorial/deep-understand-xpla/write-contract)로 넘어가셔도 좋습니다.
