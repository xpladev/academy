...
1. [Liquidity Pool 생성](/startlearning/tutorial/deep-understand-xpla/swap#create-swap-pool)
...
[3. 유동성 공급](/startlearning/tutorial/deep-understand-xpla/swap#provide-liquidity) 단계에서 Liquidity Pool에 총 10 XPLA와 10,000 ACAD를 공급하였습니다.
