...
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step1">Step 1.</span> User Client App -> Convert Server : 게임 재화를 CW20 토큰으로 바꾸는 Convert 요청 
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step2">Step 2.</span> Convert Server -> Database(DB) : DB에서 유저가 적절한 게임 재화를 보유하고 있는지 확인 후, 요청 수량만큼 유저가 보유한 재화를 감소시킴.
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step3">Step 3.</span> Convert Server : 게임 운영 지갑이 유저 지갑으로 CW20 토큰을 전송하는 unsigned 트랜잭션 생성
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step4">Step 4.</span> Convert Server -> User Client App: 유저에게 unsigned 트랜잭션을 전달
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step5">Step 5.</span> User Client App : 유저는 unsigned 트랜잭션에 서명(트랜잭션 수수료 부담에 동의)
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step6">Step 6.</span> User Client App -> Convert Server : 유저 지갑 서명이 포함된 트랜잭션을 다시 전달
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step7">Step 7.</span> Convert Server -> Database(DB) : DB에 Lock을 걸고, Sequence 값을 요청
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step8">Step 8.</span> Convert Server : Sequence 값을 이용하여 트랜잭션에 게임 운영 지갑 서명 추가
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step9">Step 9.</span> Convert Server : 유저 지갑 서명과 게임 운영 지갑 서명이 포함된 트랜잭션을 XPLA 네트워크에 전파
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step10">Step 10.</span> Convert Server -> Database(DB) : DB의 Sequence 값을 1만큼 증가시키고 Lock을 해제함
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case1-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case1-step11">Step 11.</span> Convert Server -> User Client App : 트랜잭션 결과를 유저에게 전달
</CustomHashLink>
...
<span className="text-[#004FFF] font-bold text-[17px]" id="case2-step1">Step 1.</span> User Client App -> Convert Server : CW20 토큰을 게임 재화로 바꾸는 Convert 요청 
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case2-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case2-step2">Step 2.</span> Convert Server : 유저 지갑이 게임 운영 지갑으로 CW20 토큰을 전송하는 unsigned 트랜잭션 생성
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case2-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case2-step3">Step 3.</span> Convert Server -> User Client App: 유저에게 unsigned 트랜잭션을 전달
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case2-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case2-step4">Step 4.</span> User Client App : 유저는 unsigned 트랜잭션에 서명
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case2-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case2-step5">Step 5.</span> User Client App -> Convert Server : 유저 지갑 서명이 포함된 트랜잭션을 다시 전달
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case2-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case2-step6">Step 6.</span> Convert Server : 유저 지갑 서명이 포함된 트랜잭션을 XPLA 네트워크에 전파
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case2-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case2-step7">Step 7.</span> Convert Server -> Database(DB) : 유저가 요청한 만큼 DB에 기록된 유저의 게임 재화 보유량을 증가시킴.
</CustomHashLink>
...
<CustomHashLink to="/startlearning/tutorial/deep-understand-xpla/convert#case2-pic" className="text-black">
<span className="text-[#004FFF] font-bold text-[17px]" id="case2-step8">Step 8.</span> Convert Server -> User Client App : 트랜잭션 결과를 유저에게 전달
</CustomHashLink>
