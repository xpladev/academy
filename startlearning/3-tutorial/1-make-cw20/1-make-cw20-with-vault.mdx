...
You can easily connect the gaming ecosystem to the XPLA Chain using CW20! Let's issue tokens and transfer using XPLA Vault wallet. Refer to the [previous stage](/startlearning/settings/create-wallet/create-wallet-with-vault) for downloading and creating the wallet.
...
1. [Access Vault](/startlearning/tutorial/make-cw20/make-cw20-with-vault#make-accessvault)

2. [Create CW20 Contract](/startlearning/tutorial/make-cw20/make-cw20-with-vault#instantiate)

3. [ Confirm the Contract Creation](/startlearning/tutorial/make-cw20/make-cw20-with-vault#make-confirm)
...
We've learned how to issue and transfer CW20 tokens using the Vault app. In the [next steps](/startlearning/tutorial/make-cw20/make-cw20-with-js), we'll explore how to directly issue and transfer CW20 tokens using JavaScript code.
