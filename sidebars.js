...
const sidebars = {
  tutorialSidebar: [
    ...
    },
    {
      ...
      items: ['tutorial/add-func-to-game-2/overview', 'tutorial/add-func-to-game-2/account-sequence', 'tutorial/add-func-to-game-2/walletconnect', 'tutorial/add-func-to-game-2/convert', 'tutorial/add-func-to-game-2/db-contract'],
    },
  ],
};
