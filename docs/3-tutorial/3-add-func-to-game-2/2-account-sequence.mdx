...
Preview Code를 이해하셨다면, [아래 내용](/docs/tutorial/add-func-to-game-2/account-sequence#runcode)을 읽지 않고 바로 [다음 단계](/docs/tutorial/add-func-to-game-2/local-network)로 넘어가셔도 좋습니다.
...
이렇게 Account Number와 Sequence 개념을 알아보았습니다. 이제 [다음 단계](/docs/tutorial/add-func-to-game-2/walletprovider)로 넘어가 Web3 기능을 더 자세하게 알아봅시다.