...
9. Register the created wallet as a Validator. The initial 10000000000000000000axpla (10 XPLA) is the amount you'll Self-Delegate when registering as a Validator. 
    ...
    How often validators will create blocks is determined by the total amount of XPLA delegated to them. The higher the weight, the higher the block creation rate. For more details, see [Docs](https://docs.xpla.io/docs/full-node/manage-a-validator/validator-faq/#what-is-staking).
