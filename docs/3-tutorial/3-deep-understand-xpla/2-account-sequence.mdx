...
[게임 토큰(CW20) 발행 단계](/docs/tutorial/make-cw20/make-cw20-with-js)에서 트랜잭션 서명을 진행할 때 아래처럼 **accountNumber**와 **sequence** 정보를 기입했습니다.
...
Preview Code를 이해하셨다면, [아래 내용](/docs/tutorial/deep-understand-xpla/account-sequence#runcode)을 읽지 않고 바로 [다음 단계](/docs/tutorial/deep-understand-xpla/walletprovider)로 넘어가셔도 좋습니다.
...
이렇게 Account Number와 Sequence 개념을 알아보았습니다. 이제 [다음 단계](/docs/tutorial/deep-understand-xpla/walletprovider)로 넘어가 Web3 기능을 더 자세하게 알아봅시다.