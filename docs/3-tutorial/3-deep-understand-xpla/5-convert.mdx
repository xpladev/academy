...
[Web3 Gaming Ops. 페이지](/ops)에서 제공하는 Convert 기능을 통해, 유저들은 <img src="/img/3-tutorial/3-deep-understand-xpla/5-convert/academy-diamond.svg" width="16" height="16" />를 CW20 토큰인 ACADEMY-TKN (<img src="/img/3-tutorial/3-deep-understand-xpla/5-convert/academy-token.svg" width="16" height="16" />)으로 교환할 수 있습니다.
