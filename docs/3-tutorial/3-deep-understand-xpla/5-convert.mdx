...
[1. 게임 재화(<DIAMOND />)를 CW20 토큰(<ACADEMYTKN />)으로 바꾸려는 경우](/docs/tutorial/deep-understand-xpla/convert#convert-case1)

[2. CW20 토큰(<ACADEMYTKN />)을 게임 재화(<DIAMOND />)로 바꾸려는 경우](/docs/tutorial/deep-understand-xpla/convert#convert-case2)
...
sequenceDiagram
    ...
    critical Sequence Mismatch 방지
        Note over D: DB는 게임 운영 지갑의 <br/>Sequence 값을 저장
        C->>D: Step 7
        D->>C: Sequence 값 전달
        Note over C: Step 8
        Note over C: Step 9
...
%%{init:{'themeCSS':'.messageText:nth-of-type(1) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(2) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(3) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(4) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(5) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(7) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(8) { font-weight: bold !important; fill:#004FFF;}; g:nth-of-type(5) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(5) .noteText tspan { fill: #004FFF; font-weight:bold;}; g:nth-of-type(6) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(6) .noteText tspan { fill: #004FFF; font-weight:bold;}; g:nth-of-type(7) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(8) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(8) .noteText tspan { fill: #004FFF; font-weight:bold;}; g:nth-of-type(9) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(9) .noteText tspan { fill: #004FFF; font-weight:bold;};'}}%%
```
<br/>
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 1.</span> User Client App -> Convert Server : 게임 재화를 CW20 토큰으로 바꾸는 Convert 요청 
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 2.</span> Convert Server -> Database(DB) : DB에서 유저가 적절한 게임 재화를 보유하고 있는지 확인 후, 요청 수량만큼 유저가 보유한 재화를 감소시킴.
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 3.</span> Convert Server : 게임 운영 지갑이 유저 지갑으로 CW20 토큰을 전송하는 unsigned 트랜잭션 생성
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 4.</span> Convert Server -> User Client App: 유저에게 unsigned 트랜잭션을 전달
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 5.</span> User Client App : 유저는 unsigned 트랜잭션에 서명(트랜잭션 수수료 부담에 동의)
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 6.</span> User Client App -> Convert Server : 유저 지갑 서명이 포함된 트랜잭션을 다시 전달
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 7.</span> Convert Server -> Database(DB) : DB에 Lock을 걸고, Sequence 값을 요청
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 8.</span> Convert Server : Sequence 값을 이용하여 트랜잭션에 게임 운영 지갑 서명 추가
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 9.</span> Convert Server : 유저 지갑 서명과 게임 운영 지갑 서명이 포함된 트랜잭션을 XPLA 네트워크에 전파
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 10.</span> Convert Server -> Database(DB) : DB의 Sequence 값을 1만큼 증가시키고 Lock을 해제함
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 11.</span> Convert Server -> User Client App : 트랜잭션 결과를 유저에게 전달
...
%%{init:{'themeCSS':'.messageText:nth-of-type(1) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(2) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(3) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(4) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(5) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(7) { font-weight: bold !important; fill:#004FFF;}; .messageText:nth-of-type(8) { font-weight: bold !important; fill:#004FFF;}; g:nth-of-type(5) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(5) .noteText tspan { fill: #004FFF; font-weight:bold;}; g:nth-of-type(6) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(6) .noteText tspan { fill: #004FFF; font-weight:bold;}; g:nth-of-type(7) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(7) .noteText tspan { fill: #004FFF; font-weight:bold;}; g:nth-of-type(8) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(8) .noteText tspan { fill: #004FFF; font-weight:bold;}; g:nth-of-type(9) .note { stroke: #004FFF;fill: white; }; g:nth-of-type(9) .noteText tspan { fill: #004FFF; font-weight:bold;};'}}%%
```
<br/>
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 1.</span> User Client App -> Convert Server : CW20 토큰을 게임 재화로 바꾸는 Convert 요청 
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 2.</span> Convert Server : 유저 지갑이 게임 운영 지갑으로 CW20 토큰을 전송하는 unsigned 트랜잭션 생성
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 3.</span> Convert Server -> User Client App: 유저에게 unsigned 트랜잭션을 전달
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 4.</span> User Client App : 유저는 unsigned 트랜잭션에 서명
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 5.</span> User Client App -> Convert Server : 유저 지갑 서명이 포함된 트랜잭션을 다시 전달
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 6.</span> Convert Server : 유저 지갑 서명이 포함된 트랜잭션을 XPLA 네트워크에 전파
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 7.</span> Convert Server -> Database(DB) : 유저가 요청한 만큼 DB에 기록된 유저의 게임 재화 보유량을 증가시킴.
...
<span className="text-[#004FFF] font-bold text-[17px]">Step 8.</span> Convert Server -> User Client App : 트랜잭션 결과를 유저에게 전달
