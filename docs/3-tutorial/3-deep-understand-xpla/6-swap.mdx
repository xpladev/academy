...
Swap 기능을 통해 CW20 토큰 (<img src="/img/3-tutorial/3-deep-understand-xpla/5-convert/academy-token.svg" width="16" height="16" />)과 XPLA (<img src="/img/logo192.png" width="16" height="16" />)를 교환하거나, 혹은 CW20 토큰끼리도 쉽게 교환할 수 있습니다. 
