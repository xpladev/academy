...
[Break The Bricks 게임](/#playgame)에서 사용하는 CW20 토큰<img src="/img/3-tutorial/3-deep-understand-xpla/5-convert/academy-token.svg" width="16" height="16" />과 XPLA<img src="/img/logo192.png" width="16" height="16" />를 교환하는 Swap Pool도 [Tool Page](/tool)에 있습니다. 
...
<Details summary="CW20-CW20끼리 교환하는 Swap Pool을 만들고 싶다면 어떻게 해야 하나요?">
