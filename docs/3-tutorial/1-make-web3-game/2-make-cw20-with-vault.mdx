...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/select-testnet.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/vault-testnet.png" />
</div>
</BrowserWindow>
...
예제처럼 초기값을 설정하면, 발행한 CW20 토큰의 기본 단위는 **MCT**입니다. 그런데 때로는 더 작은 단위가 필요할 수도 있습니다. CW20의 최소 단위는 기본 단위에 접두사로 **u**를 추가합니다. 예제 컨트랙트는 **uMCT**가 되겠군요.
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    <VaultImgCard style={{zIndex : 1, maxWidth : "100%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/eventlogs.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/vault-addtokens.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/vault-search.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/vault-search-token.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/vault-add-cw20.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/vault-click-send.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/send-input-amount.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/send-submit.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/send-click-txhash.png" />
</div>
</BrowserWindow>
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    <VaultImgCard style={{zIndex : 1, maxWidth : "100%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/send-explorer.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="google.com" bodyStyle={{padding: "0px 0px 16px 0px", position : 'relative'}}>
    ...
    <div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/xpla-academy-dev/img/3-tutorial/1-make-web3-game/vault/send-result.png" />
</div>
</BrowserWindow>
