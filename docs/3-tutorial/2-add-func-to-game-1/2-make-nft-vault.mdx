...
1. [Vault 접속](/docs/tutorial/add-func-to-game-1/make-nft-vault#accessvault)

2. [CW721 컨트랙트 생성](/docs/tutorial/add-func-to-game-1/make-nft-vault#instantiate)

3. [NFT 민팅하기](/docs/tutorial/add-func-to-game-1/make-nft-vault#mint-nft)
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    ...
    <VaultImgCard style={{zIndex : 1, zoom: "200%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/code_id.png" />
</div>
</BrowserWindow>

<br />

`Init msg`에는 컨트랙트의 초기값을 입력해주어야 합니다. 초기값은 발행할 NFT에 대한 정보입니다. 발행자가 누구인지(minter), NFT Collection의 이름(name) 등을 살펴볼 수 있습니다.
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    ...
    <VaultImgCard style={{zIndex : 1, zoom: "200%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/init_msg.png" />
</div>
</BrowserWindow>
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    ...
    <VaultImgCard style={{zIndex : 1, zoom: "200%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/label.png" />
</div>
</BrowserWindow>
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    <div style={{position : 'absolute', backgroundColor : '#000000CC', height : '100%', width : '100%', top : 0, zIndex : 0}} />
    <VaultImgCard style={{zIndex : 1, zoom: "200%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/success.png" />
</div>
</BrowserWindow>
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    <VaultImgCard style={{zIndex : 1, maxWidth : "100%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/success-explorer.png" />
</div>
</BrowserWindow>
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    <VaultImgCard style={{zIndex : 1, maxWidth : "100%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/eventlogs.png" />
</div>
</BrowserWindow>
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    ...
    <VaultImgCard style={{zIndex : 1, zoom: "200%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/contract-mynft.png" />
</div>
</BrowserWindow>

<br/>

`Msg` 항목에는 발행할 NFT의 정보를 적어줍니다. 예제에서는 아래와 같이 작성하겠습니다. `token_id` 항목은 NFT의 고유한 번호입니다. 따라서 같은 CW721 컨트랙트에서 발행하는 NFT는 모두 `token_id`가 달라야 합니다.
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    ...
    <VaultImgCard style={{zIndex : 1, zoom: "200%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/vault-execute.png" />
</div>
</BrowserWindow>


이외에도 `image`나 `token_uri` 항목 등을 추가할 수 있습니다. 어떤 항목을 추가할 수 있는지는 [CW721 메타데이터](https://github.com/xpladev/cw-nfts/tree/main/contracts/cw721-metadata-onchain)에 대해서 자세히 살펴보시거나, 혹은 [XPLA Explorer](https://explorer.xpla.io/)에서 다른 NFT를 참고해보시기 바랍니다.
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    <div style={{position : 'absolute', backgroundColor : '#000000CC', height : '100%', width : '100%', top : 0, zIndex : 0}} />
    <VaultImgCard style={{zIndex : 1, zoom: "200%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/execute-success.png" />
</div>
</BrowserWindow>
...
<BrowserWindow url="https://explorer.xpla.io/testnet/tx/4B4656EBDCF401AEBC672C63ABAE5E510234C46EFB395C97764445C3A1B2B130" bodyStyle={{padding: 0}}>
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    <VaultImgCard style={{zIndex : 1, maxWidth : "100%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/nft-explorer.png" />
</div>
</BrowserWindow>
...
<div className="flex justify-center" style={{backgroundColor : 'hsl(240, 20%, 97%)', position : 'relative'}}>
    <VaultImgCard style={{zIndex : 1, maxWidth : "100%"}} imgSrc="/xpla-academy-dev/img/3-tutorial/2-add-func-to-game-1/nft-messages.png" />
</div>
</BrowserWindow>
