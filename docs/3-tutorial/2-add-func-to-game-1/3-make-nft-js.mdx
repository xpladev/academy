...
Preview Code를 이해하셨다면, [아래 내용](/docs/tutorial/add-func-to-game-1/make-nft-js#instantiate-runjs)을 읽지 않고 바로 [다음 단계](/docs/tutorial/add-func-to-game-2/overview)로 넘어가셔도 좋습니다.
