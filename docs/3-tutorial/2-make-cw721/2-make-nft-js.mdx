...
If you've fully understood the Preview Code, feel free to skip reading the [following](/docs/tutorial/make-cw721/make-nft-js#instantiate-runjs) and move on to the [next step](/docs/tutorial/make-cw721/query-cw721).
...
### Description {#instantiate-explaination}
...
### Description {#makenft-explaination}
...
In the [next chapter](/docs/tutorial/make-cw721/query-cw721), we are going to retrieve the date of the NFT we made ourselves from the blockchain!