...
import {GameArchitectureTutorial2, GameArchitectureAdvanced2} from "@site/src/components/GameArchitecture";

[Break The Bricks 게임](/#playgame)에는 Tutorial 과정과 Advanced 과정이 있습니다. 먼저 Tutorial 과정이 어떻게 구성되어 있는지 살펴봅시다.

<GameArchitectureTutorial2 />
