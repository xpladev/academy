...
<Tabs groupId="operating-systems">
  ...
  <TabItem value="win" label="Windows">
    1. Windows 환경에서 Linux를 사용하기 위해, <Link to="https://learn.microsoft.com/en-us/windows/wsl/install">WSL(Windows Subsystem for Linux)</Link>이 필요합니다. WSL을 설치하고, 실행해주세요.
    <br />
    <br />
