...
Preview Code를 이해하셨다면, [아래 내용](/docs/settings/create-testnet-transaction/send-query#runjs)을 읽지 않고 바로 [다음 단계](/docs/settings/create-testnet-transaction/use-xplad)로 넘어가셔도 좋습니다.
...
이로써 XPLA 블록체인에 트랜잭션을 생성하고, 데이터를 가져오실 수 있게 되었습니다! [다음 단계](/docs/settings/create-testnet-transaction/use-xplad)에서 더 깊이 공부해봅시다.
