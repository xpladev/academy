...
xplad로 cli에서 트랜잭션을 생성하고, query를 보낼 수도 있습니다. [이전 단계](/docs/settings/create-wallet/create-wallet-with-xplad)에서 xplad를 설치하지 않으셨다면, [다음 단계](/docs/tutorial/make-web3-game/download-code)로 넘어가셔도 좋습니다. 
