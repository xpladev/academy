...
<div className="flex justify-end" style={{zIndex : 1,position:'relative'}}>
    <VaultImgCard imgSrc="/academy/img/2-settings/2-create-testnet-transaction/send-tx/sendtx-checkfee.png" />
</div>
</BrowserWindow>
...
Specify the sending wallet address, receiving wallet address, and token information. 예제에서는 Faucet 지갑 주소인 `xpla1a8f3wnn7qwvwdzxkc9w849kfzhrr6gdvy4c8wv`으로 25aXPLA만큼 보내겠습니다.
