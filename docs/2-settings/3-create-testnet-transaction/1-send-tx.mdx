...
Quickstart Code를 이해하셨다면, [아래 내용](/docs/settings/create-testnet-transaction/send-tx#runjs)을 읽지 않고 바로 [다음 단계](/docs/settings/create-testnet-transaction/check-tx-in-explorer)로 넘어가셔도 좋습니다.
...
4. Terminal에서 결과를 확인합니다. 트랜잭션의 해시값을 확인할 수 있을 것입니다.
...
<div className="flex justify-end">
    <VaultImgCard imgSrc="/xpla-academy-dev/img/2-settings/2-create-testnet-transaction/sendtx-checkfee.png" />
</div>
</BrowserWindow>
...
그런데 트랜잭션을 보낸 기록을 더 자세히 살펴보려면 어떻게 해야할까요? 하나는 XPLA의 모든 트랜잭션 기록을 살펴볼 수 있는 [XPLA Explorer](https://explorer.xpla.io/)를 이용하는 것입니다. 또 다른 방법으로는 직접 코드로 트랜잭션 데이터 값을 받아오는 것입니다.
